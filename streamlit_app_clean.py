...
# Add navigation tabs
tab1, tab2 = st.tabs(["🎯 Skills & Videos", "📊 Market Analysis"])
...
with tab2:
    ...
    st.caption("Analyze job market trends, skill demands, and hiring patterns")
    ...
    if run_analysis and analysis_job_title.strip():
        ...
        if analysis_cache_key in st.session_state:
            ...
            with st.spinner("🔍 Analyzing LinkedIn job market... This may take a few minutes."):
                try:
                    ...
                    # Get job statistics with experience level filter
                    job_data = analyzer.get_job_statistics_with_experience(
                        analysis_job_title, 
